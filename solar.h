...
public:
	CSolar(void);
	~CSolar(void);
	void SetVal(int Day, double Time, double Lat,  double Longi, double Alti, double SolRad0, double PFD);
	...
	double GetPotentialPARDirect()  {return PotentialPARDirect;}
	double GetPotentialPARDiffuse() {return PotentialPARDiffuse;}
	double GetPotentialNIRDirect() { return PotentialNIRDirect; }
	double GetPotentialNIRDiffuse() { return PotentialNIRDiffuse; }
