...
void CSolar::SetVal(int Day, double Time, double Lat,  double Longi, double Alti, double SolRad0, double PFD) // Altitude available
{
	...
	JDay = Day;
	this->Time = Time;// this->Time should be in hours so no need to multiply with 24
...
// set up potential radiation values
	...
	SolarRadiation = PFD / cPFD / PARFraction;
